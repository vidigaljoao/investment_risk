...
#             raise TypeError("portfolio_data must be a Pandas DataFrame")
    ...
    def plot_simulation(self):
        ...
        ax = self.simulated_return.plot(legend=None,title=plot_title)
#         ax.figure.savefig('data/plot/mt_carlo_sim.png')
        return fig
    ...
    def plot_distribution(self):
        ...
        ax = self.simulated_return.iloc[-1, :].plot(kind='hist', bins=30,density=True,title=plot_title)
        ax.axvline(self.confidence_interval.iloc[0], color='r')
        ax.axvline(self.confidence_interval.iloc[1], color='r')
#         ax.figure.savefig('data/plot/mt_carlo_Prob_dist.png')
        return fig
